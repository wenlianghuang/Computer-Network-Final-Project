...
public class SignupandinExample extends JFrame implements ActionListener{
    ...
    SignupandinExample(){
        ...
        male.setLocation(180,200);
        add(male);

        female = new JRadioButton("Female");
        female.setFont(new Font("Arial",Font.PLAIN,20));
        female.setSize(125,20);
        female.setSelected(false);
        female.setLocation(260,200);
        add(female);

        //To let the radiobutton for only "one"
        mfg = new ButtonGroup();
        mfg.add(male);
        mfg.add(female);
        ...
        month = new JComboBox<String>(monthes);
    ...
    public static void main(String[] args) throws Exception {
        SignupandinExample upandin = new SignupandinExample();
        upandin.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    }
}
